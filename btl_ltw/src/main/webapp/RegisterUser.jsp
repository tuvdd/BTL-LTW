...
<body>
	<div>
		<div id="login-form" class="container center _80pc login-panel">
			...
			<form class="center" method="post" action="/user/register">
				<div class="form-label">
					<img class="form-label-icon" src="/admin/resources/img/email.png">
					<label class="form-label-text">Email:</label>
				</div>
				<input type="text" name="email">
                <div class="form-label">
					<img class="form-label-icon" src="/admin/resources/img/phonecall.png">
