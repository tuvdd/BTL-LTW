<%@ page import="java.util.*, servlets.admin.ServletUtil, models.dtos.*" language="java"
    contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <h1 id="title-page">Quản lý đơn hàng</h1>
        <% List<AdminOrderPreview> listAdminOrderPreviews = (List<AdminOrderPreview>)
                request.getAttribute("listAdminBookViews");
                        ...
                        <tbody>
                            <c:forEach var="order" items="${listAdminOrderPreviews}">
                                <tr>
                                    ...
                                    <td><a href="/btl_ltw/admin/order/detail?id=${order.id}">Chi tiết</a>
                                        <a href="/btl_ltw/admin/order/delete?id=${order.id}">Xóa</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
