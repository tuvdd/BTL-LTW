function showEditModal(tr_id) {
    ...
    edit_quantity = document.getElementById("edit-quantity");
    ...
    edit_quantity.value = tr.children[8].innerHTML
    edit_description.value = tr.children[9].innerHTML
    edit_sub_description.value = tr.children[10].innerHTML
}
